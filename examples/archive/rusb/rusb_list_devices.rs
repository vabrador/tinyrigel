...
use rusb::{ConfigDescriptor, DeviceDescriptor, DeviceHandle, DeviceList, EndpointDescriptor, InterfaceDescriptor, Language, Speed, UsbContext};
...
fn print_interface<T: UsbContext>(
  ...
  if !interface_desc.extra().is_none() {
